...
const Calendar = () => {
    ...
    const handleEventClick = (selected) => {
        if (window.confirm(`Are u sure u want to delete the event '${selected.event.title}'`)) {
        ...
        <Box display="flex" justifyContent="space-between">
            ...
            <Box flex="1 1 100%" ml="15px">
                    <FullCalendar
                        ...
                        initialEvents={[
                            {id:"1234", title: "All-day event", date: "2024-08-28"},
                            {id:"4321", title: "Timed event", date: "2024-08-31"}
                        ]}
                    />
            </Box>
        </Box>
